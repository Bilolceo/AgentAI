...
const DICT: Record<string, Entry> = {
  ...
  appt_delete: { uz: "O'chirish", ru: "Удалить" },
  appt_delete_confirm: { uz: "Bu qabulni butunlay o'chirasizmi?", ru: "Удалить эту запись навсегда?" },
  ...
  rahbar_action_title: { uz: "Tasdiqingizni kutmoqda", ru: "Ожидают вашего подтверждения" },
  rahbar_action_hint: { uz: "Tasdiqlang yoki rad eting. Tasdiqlangach, mijozga avtomatik SMS boradi.", ru: "Подтвердите или отклоните. После подтверждения клиенту уйдёт SMS." },
  rahbar_action_empty: { uz: "Hammasi joyida — tasdiq kutayotgan qabul yo'q.", ru: "Всё в порядке — заявок на подтверждение нет." },
  rahbar_details: { uz: "Batafsil", ru: "Подробнее" },
  rahbar_lead_no_time: { uz: "Vaqt belgilanmagan · qo'ng'iroq qiling", ru: "Время не назначено · перезвоните" },
  cal_legend: { uz: "Holatlar", ru: "Статусы" },
  view_agenda: { uz: "Ro'yxat", ru: "Список" },
  view_calendar: { uz: "Kalendar", ru: "Календарь" },
  agenda_empty_week: { uz: "Bu haftada qabul yo'q.", ru: "На этой неделе приёмов нет." },
  appts_count: { uz: "qabul", ru: "приёмов" },
