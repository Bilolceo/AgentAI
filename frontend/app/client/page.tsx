          ...
          <Anim delay={120} from="right">
            {sent ? (
              ...
              <div className="rounded-2xl bg-white ring-1 ring-gray-100 shadow-sm">
                ...
                <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} className="space-y-4 p-6">
                  <div>
                  ...
                  <button
                    type="submit"
                    className="w-full rounded-full bg-teal-500 py-3 text-sm font-semibold text-white transition-all hover:bg-teal-600 hover:shadow-md hover:shadow-teal-200 active:scale-[0.98]"
                  >
